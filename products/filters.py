...
class ProductFilter(FilterSet):
    ...
    brand = Product.objects.filter(field_name='brand__name',lookup_expr='icontains').filter(field_name='brand__name',lookup_expr='icontains').filter(field_name='brand__name',lookup_expr='icontains')
